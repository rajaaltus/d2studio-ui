    ...
    <section className="w-full min-h-screen bg-white dark:bg-[#000000] py-16 px-4 md:px-6 flex flex-col items-center gap-8 font-sans transition-colors duration-500 overflow-x-hidden">
      ...
      <div className="w-full max-w-[1280px] pt-4 relative min-h-[580px]">
        ...
        {activeTab === "data" && (
          <div
            key="data"
            className="bg-[#F9F9F9] dark:bg-[#0F0E0E] rounded-[32px] border border-zinc-200 dark:border-[#1F1F1F] p-5 animate-spring-in"
          >
        ...
        {activeTab === "engagement" && (
          ...
          >
            {[
              ...
              <div
                key={idx}
                className="bg-[#F9F9F9] dark:bg-[#0F0E0E] rounded-[32px] border border-zinc-200 dark:border-[#1F1F1F] p-3 group/strat flex flex-col"
              >
