        ...
        <div className="min-h-screen bg-white text-gray-900 font-sans p-6 sm:p-8 md:p-16 flex flex-col items-center">
            ...
            <div className="max-w-5xl w-full mb-8 sm:mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="text-gray-500 max-w-2xl text-base sm:text-lg leading-relaxed">
                    From interactive workshop to certification programs, our platforms provides
                    comprehensive tools for faculty development and institutional growth.
                </p>
            </div>
            ...
            {isLoading ? (
                    ...
                    <Card className="sm:col-span-6 lg:col-span-4 bg-gray-50/50 border-gray-100 shadow-none rounded-3xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-both">
                        <CardContent className="p-5 sm:p-6 h-full flex flex-col">
                            <div className="mb-4 sm:mb-6">
                                ...
                                <p className="text-sm text-gray-500">Monitor platform health and revenue.</p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 flex-1">
                                ...
                                <div className="sm:w-32 bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex flex-row sm:flex-col justify-between sm:justify-between gap-4 sm:gap-0">
                                    <div>
                                        <div className="text-[10px] font-semibold text-gray-900">Enrollment Trend</div>
                                        <div className="text-[9px] text-gray-400">Last 14 days</div>
                                        <div className="text-xl font-bold text-gray-900 mt-1 sm:mt-2">1,521</div>
                                    </div>
                    ...
                    <Card className="sm:col-span-6 lg:col-span-4 bg-gray-50/50 border-gray-100 shadow-none rounded-3xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                        <CardContent className="p-5 sm:p-6 h-full flex flex-col">
                            ...
                            <div className="mt-auto">
                                <h3 className="font-semibold text-gray-900">Dashboard & Multi-Role Access</h3>
                                <p className="text-sm text-gray-500 mt-1 leading-relaxed">
                                    Get real-time insights with dashboards tailored for every user, from admin to faculty, using granular permissions for simplified, secure access.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
                ...
                @keyframes beam-travel-1 {
                  0%, 15% { width: 0; opacity: 0; left: 0; }
                  20% { opacity: 1; }
                  40% { width: 100%; opacity: 1; left: 0; }
                  45% { width: 0; opacity: 0; left: 100%; }
                ...
                @keyframes beam-travel-2 {
                  0%, 50% { width: 0; opacity: 0; left: 0; }
                  55% { opacity: 1; }
                  75% { width: 100%; opacity: 1; left: 0; }
                  80% { width: 0; opacity: 0; left: 100%; }
                  100% { width: 0; opacity: 0; left: 100%; }
                }
                @keyframes user-ripple {
                  0%, 75% { box-shadow: 0 0 0 0 rgba(99, 102, 241, 0); }
                  80% { box-shadow: 0 0 0 10px rgba(99, 102, 241, 0.1); }
                ...
                .loader-ring.indigo span {
                  background-image: linear-gradient(-225deg, #4f46e5 0%, #6366f1 50%, #818cf8 100%);
                }
                .loader-ring.green span {
                  background-image: linear-gradient(-225deg, #16a34a 0%, #22c55e 50%, #4ade80 100%);
                }

                .animate-office-glow { animation: office-glow 4s infinite; }
                .animate-beam-1 { animation: beam-travel-1 4s infinite ease-in-out; }
                .animate-lightning-pulse { animation: lightning-pulse 4s infinite; }
                .animate-beam-2 { animation: beam-travel-2 4s infinite ease-in-out; }
                .animate-user-ripple { animation: user-ripple 4s infinite; }
              `}</style>
                            ...
                            <div className="mt-auto text-center sm:text-left">
                                <h3 className="font-semibold text-gray-900">A Complete Platform</h3>
                                <p className="text-sm text-gray-500 mt-1 leading-relaxed">
                    ...
                    <Card className="sm:col-span-12 lg:col-span-6 bg-gray-50/50 border-gray-100 shadow-none rounded-3xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                        <CardContent className="p-5 sm:p-6 h-full flex flex-col">
                            <div className="mb-4 sm:mb-6">
                                ...
                                <p className="text-sm text-gray-500">Create, schedule, and manage program.</p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <div className="flex-1 bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
                                    <div className="mb-3">
                                        <div className="text-xs font-semibold text-gray-900">Create Program</div>
                                        <div className="text-[10px] text-gray-400">Title, dates, fee, capacity</div>
                                    </div>
                                    <div className="space-y-2">
                                        {[1, 2].map((i) => (
                                            <div key={i} className="flex items-center justify-between p-2 rounded-lg border border-gray-50 bg-gray-50/50">
                                                <div className="min-w-0 mr-2">
                                                    <div className="text-[10px] font-medium text-gray-900 truncate">Sessions 02 - Evaluating AI Tools</div>
                                                    <div className="text-[9px] text-gray-400">10:00 AM - 11:30 AM IST • Room B-301</div>
                                                </div>
                                                <Button variant="outline" size="sm" className="h-6 text-[9px] px-2 bg-white border-gray-200 shrink-0">
                                                    Mark Attendance
                                                </Button>
                                            </div>
                                        ))}
                                ...
                                <div className="sm:w-48 bg-white rounded-xl border border-gray-100 p-4 shadow-sm flex flex-col gap-2">
                                    ...
                                    <Input className="h-7 text-[10px] px-2" placeholder="Program title" />
                                    <div className="flex gap-2">
                                        <Input className="h-7 text-[10px] px-2" placeholder="Start" />
                                        <Input className="h-7 text-[10px] px-2" placeholder="End" />
                                    </div>
                                    <div className="flex gap-2">
                                        <Input className="h-7 text-[10px] px-2" placeholder="Fee" />
                                        <Input className="h-7 text-[10px] px-2" placeholder="Capacity" />
                                    </div>
                    ...
                    <Card className="sm:col-span-12 lg:col-span-6 bg-gray-50/50 border-gray-100 shadow-none rounded-3xl overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 fill-mode-both">
                        <CardContent className="p-5 sm:p-6 h-full flex flex-col">
                            <div className="mb-4 sm:mb-6">
                                ...
                                <p className="text-sm text-gray-500">Enroll, complete assignment, download certificate.</p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <div className="sm:w-48 bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
                                    <div className="mb-3">
                                        <div className="text-xs font-semibold text-gray-900">Current Enrollment</div>
                                        <div className="text-[10px] text-green-600 font-medium">2 active</div>
                                    </div>
                                    <div className="space-y-3">
                                        {[
                                            { name: "Modern Web", time: "Tue 10:00", progress: "70%" },
                                            { name: "AI for Educators", time: "Wed 14:00", progress: "45%" },
                                            { name: "Data Science Bootcamp", time: "Thu 16:00", progress: "60%" },
                                        ].map((item) => (
                                            <div key={item.name} className="flex items-center justify-between">
                                                <div className="min-w-0 mr-2">
                                                    <div className="text-[10px] font-medium text-gray-900 truncate">{item.name}</div>
                                                    <div className="text-[9px] text-gray-400">Next session: {item.time}</div>
                                                </div>
                                                <div className="text-[10px] font-bold text-gray-700 shrink-0">{item.progress}</div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 bg-white rounded-xl border border-gray-100 p-4 shadow-sm flex flex-col">
                                    <div className="mb-3">
                                        ...
                                        <div className="text-[10px] text-gray-400">Upload & track feedback</div>
                                    </div>
                                    <div className="flex-1 min-h-[2rem]" /> {/* Spacer */}
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="text-[10px] font-medium text-gray-900">Rubric draft</div>
                                        <Badge variant="secondary" className="h-5 text-[9px] bg-red-50 text-red-600 hover:bg-red-50 border-none">Due Fri</Badge>
                                    </div>
                                    <div className="flex gap-2">
