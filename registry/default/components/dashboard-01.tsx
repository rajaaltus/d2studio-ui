    ...
    return (
        <Card className="bg-white border-gray-200 shadow-[0_1px_2px_rgba(0,0,0,0.05)] rounded-xl">
            <CardContent className="p-4 sm:p-5">
                ...
                <div className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1.5">{value}</div>
                <div
                    className={cn(
        ...
        <>
            ...
            <div className="px-5 py-4 border-b border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-sm font-medium text-gray-700">Studio Management</span>
                </div>
                <Button
                    variant="outline"
            ...
            <nav className="flex-1 px-4 py-4 overflow-y-auto">
                ...
                <div className="mb-5">
                    ...
                    <div className="space-y-0.5">
                        <NavItem icon={User} label="Guest Booking" active onClick={onClose} />
                        ...
                        <NavItem icon={CheckCircle} label="Do not Disturb" onClick={onClose} />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-0.5">
                        ...
                        <NavItem icon={Lock} label="System and Security" onClick={onClose} />
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            <div className="flex items-start justify-between mb-3">
                <div>
                    <div className="font-medium text-gray-900 text-sm">{booking.guestName}</div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40">
                            <DropdownMenuItem className="text-gray-700">View Details</DropdownMenuItem>
                            <DropdownMenuItem className="text-gray-700">Edit Booking</DropdownMenuItem>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
                <div>
                    ...
                    <div className="font-medium text-gray-800">{booking.roomNumber} · {booking.roomType}</div>
                </div>
                <div>
                ...
                <div className="p-4 sm:p-5 lg:p-6 space-y-4 sm:space-y-5 lg:space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        ...
                        >
                            ...
                            <span className="text-gray-700 truncate">Aug 20 – Sep 09, 2025</span>
                        </Button>
                    </div>

                    {/* Metric cards — 2-col on mobile, 4-col on md+ */}
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                        <MetricCard title="Total Vacancy" value="12" change="+ 14.3%" trend="up" />
                        <MetricCard title="Total Booked" value="44" change="+ 14.3%" trend="up" />
                        <MetricCard title="Pending Check-outs" value="15" change="- 8.1%" trend="down" />
                        <MetricCard title="Total Guests" value="58" change="+ 16.4%" trend="up" />
                    </div>
                    ...
                    <div className="xl:hidden space-y-3">
                        <div className="flex items-center justify-between">
                            <h2 className="text-sm font-semibold text-gray-900">
                                All Bookings
                                <Badge variant="secondary" className="ml-2 text-[10px] py-0">{bookings.length}</Badge>
                            </h2>
                        </div>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="border-gray-200 hover:bg-transparent bg-gray-50/60">
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Guest</TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5"></TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Room</TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Check-in</TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Check-out</TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Payment</TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Status</TableHead>
                                            <TableHead className="text-gray-700 font-semibold py-4 px-5">Actions</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        {bookings.map((booking) => (
                                            ...
                                            >
                                                ...
                                                <TableCell className="py-4 px-5">
                                                    <div>
                                                        <div className="font-medium text-gray-900 text-sm">{booking.roomNumber}</div>
                                                        <div className="text-xs text-gray-400">{booking.roomType}</div>
                                                    </div>
                                                </TableCell>
                                                <TableCell className="py-4 px-5 text-gray-700 text-sm">{booking.checkIn}</TableCell>
                                                <TableCell className="py-4 px-5 text-gray-700 text-sm">{booking.checkOut}</TableCell>
                                                <TableCell className="py-4 px-5 text-gray-900 font-semibold text-sm">${booking.payment}</TableCell>
                                                <TableCell className="py-4 px-5">
                                                    <StatusBadge status={booking.status} />
                                                </TableCell>
                                                <TableCell className="py-4 px-5">
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end" className="w-40">
                                                            <DropdownMenuItem className="text-gray-700">View Details</DropdownMenuItem>
                                                            <DropdownMenuItem className="text-gray-700">Edit Booking</DropdownMenuItem>
                                                            <DropdownMenuItem className="text-red-600 focus:text-red-700">Cancel Booking</DropdownMenuItem>
                                                        </DropdownMenuContent>
                                                    </DropdownMenu>
                                                </TableCell>
                                            </TableRow>
