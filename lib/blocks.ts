...
export type BlockDef = {
  ...
  /** Printed by the shadcn CLI after install: setup the item needs beyond its files. */
  docs?: string;
  /**
   * Which browse shelf draws it: /blocks for page sections, /components for the
   * primitives. An item with no shelf is installable but never listed — a hook,
   * or a part some other block pulls in.
   */
  shelf?: "blocks" | "components";
...
export const BLOCK_LIBRARY: BlockDef[] = [
  ...
  // Each is drawn on /components from its demo in registry/default/examples;
  // designed use cases built on them are their own items on /blocks.
  ...
  },
  {
    ...
    categories: ["overlays"],
    docs: "The `tooltip` component has been added. Wrap your app in `TooltipProvider` (from `@/components/ui/tooltip`), usually in app/layout.tsx.",
    dependencies: ["radix-ui"],
    shelf: "components",
    image: "/ui/tooltip.jpg",
    status: "available",
  },
  {
    name: "use-mobile",
