...
export default function UiUxMagicCard() {
    return (
        <div className="relative flex h-full min-h-[311px] w-full flex-col justify-center overflow-hidden rounded-2xl border border-[var(--b4-border)] bg-[var(--b4-surface)] p-6">
            {/* Figma mark (right) */}
            <svg
                aria-hidden
            ...
            <h3 className="relative mt-5 bg-gradient-to-b from-[var(--b4-title-from)] to-[var(--b4-title-to)] bg-clip-text text-[18px] font-semibold leading-tight text-transparent">
                UI/UX Magic
            </h3>
            <p className="relative mt-2 max-w-[160px] text-[13px] leading-relaxed text-[var(--b4-body)]">
