...
export default function AccelerateCard() {
    return (
        <div className="group relative flex h-full min-h-[236px] w-full flex-col overflow-hidden rounded-2xl border border-[var(--b4-border)] bg-[var(--b4-surface)] p-5">
            ...
            <div className="relative grid h-14 w-14 shrink-0 place-items-center rounded-full border border-[var(--b4-border)] bg-[var(--b4-tile)]">
                <svg width="21.6" height="21.6" viewBox="37 37 22 22" fill="none" className="overflow-visible" aria-hidden>
                    <path
